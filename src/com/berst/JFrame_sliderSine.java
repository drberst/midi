...
public class JFrame_sliderSine extends JFrame {
  ...
  class SampleThread extends Thread {
    ...
    //the response to the slider movement, but if you make it too small you will getNote
...
//    final static public double BUFFER_DURATION = 0.100;      //About a 100ms buffer
    ...
    //Continually fill the audio output buffer whenever it starts to getNote empty, SINE_PACKET_SIZE/2
